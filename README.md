...
* 文字または数字の書かれたボタンをクリックすると、それを読み上げ、あらかじめ登録してある画像を表示するという仕様です。
* お子様の好みに合わせた画像を表示させることで、学習意欲を引き出す狙いがあります。

**How to build**
1. Visual Studioでビルドするため、インストールします。
2. Visual Studioにて、本リポジトリのクローンで新規プロジェクトを作成します。
3. Releaseビルドしてください。
4. ビルドが成功するとEducationReader\bin\Release内に実行ファイル(.exe)が生成されます。
